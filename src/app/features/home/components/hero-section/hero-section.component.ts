    ...
    <section class="relative bg-primary-navy overflow-hidden min-h-screen flex items-center pt-24 lg:pt-32 pb-20 bg-cover bg-center" style="background-image: url('assets/backgrounds/hero-bg.png');">
      ...
      <div class="container-main relative z-20 w-full h-full flex flex-col justify-center">
        ...
        <div class="flex flex-col text-white max-w-[800px]">
           <h1 appReveal revealDirection="left" [revealDelay]="100" class="font-bdo font-semibold text-4xl md:text-5xl lg:text-[64px] lg:leading-[83px] tracking-[-0.03em] align-middle uppercase">
           ...
           <p appReveal revealDirection="left" [revealDelay]="250" class="font-bdo font-normal text-[18px] leading-[30px] tracking-normal text-hero-description max-w-[500px] mt-6">
           ...
           <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 mt-12 max-w-2xl">
             @for (feature of features; track feature.text; let i = $index) {
               <div appReveal revealDirection="left" [revealDelay]="400 + (i * 150)" class="flex items-center gap-[10px]">
           ...
           <div appReveal revealDirection="left" [revealDelay]="1000" class="mt-14 flex items-center">
