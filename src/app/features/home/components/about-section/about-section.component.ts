        ...
        <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_454px] gap-16 lg:gap-24 items-start">
          ...
          <div class="flex flex-col gap-12">
            ...
            <div class="flex flex-col items-start gap-6">
              <div appReveal revealDirection="left" [revealDelay]="0" class="inline-flex items-center gap-2 bg-white rounded-[7px] px-4 min-h-[32px] shadow-sm">
              ...
              <h2 appReveal revealDirection="left" [revealDelay]="150" class="text-[28px] md:text-[36px] leading-[1.3] font-bold font-bdo text-[#0A1642] tracking-normal">
          ...
          <!-- Right Image Area -->
          <div appReveal revealDirection="right" [revealDelay]="300" class="relative w-full lg:w-[454px] aspect-[454/676] rounded-[40px] overflow-hidden mt-8 lg:mt-[65px]  shadow-[0_20px_40px_rgba(0,0,0,0.08)]">
